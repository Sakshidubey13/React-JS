...
//        animate={{ y: 0 }}
//        transition={{ duration: 0.5 }}
//        className={`flex items-center justify-between w-[95%] max-w-6xl ${colors.navBg} backdrop-blur-lg rounded-2xl px-6 py-3 shadow-lg`}
//      >
//        {/* Logo */}
//        <motion.a
//          href="/"
...
//          className={`absolute top-20 w-[90%] max-w-md ${colors.navBg} backdrop-blur-lg rounded-xl shadow-lg p-6 lg:hidden`}
//        >
